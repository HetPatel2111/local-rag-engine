...
title: "Performance"
created_at: "2026-05-26T05:15:04.853976+00:00"
---
# Performance
...
```
export * from './color.js' export * from './dom.js' export * from './slash.js'
```
...
```
vite:transform 28.72ms /@vite/client +1ms vite:transform 62.95ms /src/components/BigComponent.vue +1ms vite:transform 102.54ms /src/utils/big-utils.js +1ms
```

```
export default defineConfig ({ server: { warmup: { clientFiles: [ './src/components/BigComponent.vue' , './src/utils/big-utils.js' , ], }, }, })
```
