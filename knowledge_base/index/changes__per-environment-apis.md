---
url: "https://vite.dev/changes/per-environment-apis"
title: "Move to Per-environment APIs"
created_at: "2026-05-26T05:14:57.755787+00:00"
---
...
```
future : { removeServerModuleGraph : 'warn' , removeServerReloadModule : 'warn' , removeServerPluginContainer : 'warn' , removeServerHot : 'warn' , removeServerTransformRequest : 'warn' , removeServerWarmupRequest : 'warn' , }
```
