---
url: "https://vite.dev/changes/this-environment-in-hooks"
title: "this.environment in Hooks"
created_at: "2026-05-26T05:14:58.076843+00:00"
---
...
```
import { Plugin } from 'vite' export function myPlugin () : Plugin { return { name: 'my-plugin' , resolveId ( id , importer , options ) { const isSSR = options.ssr const isSSR = this .environment.config.consumer === 'server' if (isSSR) { // SSR specific logic } else { // Client specific logic } }, } }
```
